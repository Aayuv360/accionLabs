        ...
        <tbody>
          <tr>
           ...
           <tr>
            ...
            <td style={{ padding: 8, border: "1px solid #ccc" }}>$2999</td>
            <td style={{ padding: 8, border: "1px solid #ccc" }}>
              <span
                style={{
                  background: "#d1fae5",
           ...
           <tr>
            ...
            <td style={{ padding: 8, border: "1px solid #ccc" }}>ProBook</td>
            <td style={{ padding: 8, border: "1px solid #ccc" }}>$2099</td>
            <td style={{ padding: 8, border: "1px solid #ccc" }}>
              <span
                style={{
                  background: "#d1fae5",
           ...
           <tr>
            ...
            <td style={{ padding: 8, border: "1px solid #ccc" }}>ProBook</td>
            <td style={{ padding: 8, border: "1px solid #ccc" }}>$3999</td>
            <td style={{ padding: 8, border: "1px solid #ccc" }}>
              <span
                style={{
                  background: "#d1fae5",
           ...
           <tr>
            ...
            <td style={{ padding: 8, border: "1px solid #ccc" }}>$1999</td>
            <td style={{ padding: 8, border: "1px solid #ccc" }}>
              <span
                style={{
                  background: "#d1fae5",
